...
class SubCategoriesControllerTest < ActionController::TestCase
  ...
  test "should create sub_category" do
    assert_difference('SubCategory.count') do
      post :create, sub_category: { category_id: @sub_category.category_id, description: @sub_category.description, name: @sub_category.name, slug: @sub_category.slug }
    end
  ...
  test "should update sub_category" do
    patch :update, id: @sub_category, sub_category: { category_id: @sub_category.category_id, description: @sub_category.description, name: @sub_category.name, slug: @sub_category.slug }
    assert_redirected_to sub_category_path(assigns(:sub_category))
  end
